...
ClusterAnalysisWrapper::ClusterAnalysisWrapper()
    : _cutoff(3.2),
      _sortBySize(true),
...
void ClusterAnalysisWrapper::setCutoff(double cutoff){
    _cutoff = cutoff;
}

void ClusterAnalysisWrapper::setOptions(
    bool sortBySize,
...
std::shared_ptr<ParticleProperty> ClusterAnalysisWrapper::createPositionProperty(const LammpsParser::Frame &frame){
...
json ClusterAnalysisWrapper::compute(const LammpsParser::Frame& frame, const std::string& outputFilename){
